                ...
                <div class="mb-6 space-y-4">
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <select wire:model.live="role" class="rounded-md border-0 py-2 pl-3 pr-8 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6">
                                <option value="">{{ __('All Roles') }}</option>
                                @foreach ($personRoles as $personRole)
                                    <option value="{{ $personRole->value }}">{{ ucfirst($personRole->value) }}</option>
                                @endforeach
                            </select>
                            <input type="date" wire:model.live="joinDateFrom" class="rounded-md border-0 py-2 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6" placeholder="{{ __('From') }}" title="{{ __('Join date from') }}">
                            <input type="date" wire:model.live="joinDateTo" class="rounded-md border-0 py-2 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-500 sm:text-sm sm:leading-6" placeholder="{{ __('To') }}" title="{{ __('Join date to') }}">
